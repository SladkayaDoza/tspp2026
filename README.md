...
Розробити програму, яка читає із файлу БД MySQL ([library.sql]) інформацію про  магазин «Книжкозавр», про які відомо:
 
| Дані | Назва поля у БД | Формат поля у БД |
| ------ | ------ | ------ |
| назва книги | name	| varchar(25) |
| ціна | cost	| double |
| кількість | number | int |
| вікові межі | age | int(2) |


**Користувач – продавець магазину** може додавати записи про нові отримані книги, редагувати інформацію у формі програми. Для доступу до функцій роботи із даними про рейси робітник комнанії має авторизуватись (пункт головного меню)
**Користувач – покупець** може передивлятися в головній формі програми перелік усіх книг та виконувати пошук інформації:
- навза книги X,
- ціна X,
- вікові межі від X до Y.


Значення X, Y вводяться користувачем у відповідні поля головної форми. 
Результати відбору інформації користувач – клієнт може зберегти у файл MS Word, який формується на основі шаблону [Template MS Word] Шаблон_Пошуку_книг.dot.

Про компанію «Книгозавр» відомо, що більше 1500 рейсів вона не може здійснювати.

## Обмеження проекту
- Тривалість проекту із розроблення ПП – з 16.02.2026р. до 07.06.2026р.
